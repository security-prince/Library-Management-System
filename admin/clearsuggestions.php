...
<div class='gap'></div>
	...
	<div class='gap'></div>
<div class="container">
<center><h2>Clear Suggestions</h2>
<?php
include('../connect.php');
...
if (mysqli_num_rows($result) > 0) {
    while($row = mysqli_fetch_assoc($result)) {
    	$id=$row["id"];
        echo "<li>ID&nbsp;: " . $row["id"]. ":&nbsp;&nbsp;&nbsp; Name: " . $row["name"]. "&nbsp&nbsp&nbsp||&nbsp&nbsp; Email &nbsp;: " . $row["email"]. "&nbsp&nbsp&nbsp||&nbsp&nbsp;&nbsp&nbsp; Suggestions &nbsp;: " . $row["idea"]. "||&nbsp&nbsp;&nbsp&nbsp;<a href=\"?id=$id\">Clear Suggestions </a><br><br>";
    }
} else {
...
if(isset($_GET['id'])){
	...
	$sqli="DELETE FROM `contact` WHERE `id` = '". $del ."'";
